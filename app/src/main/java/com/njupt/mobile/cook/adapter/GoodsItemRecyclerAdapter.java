...
import static com.njupt.mobile.cook.util.GlideUtil.REQUEST_OPTIONS;
...
public class GoodsItemRecyclerAdapter extends RecyclerView.Adapter<GoodsItemRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final int resId = ((ResActivity)mContext).getGoodsListBean().getResId();
        final String resName = ((ResActivity)mContext).getGoodsListBean().getResName();
        //设置名
