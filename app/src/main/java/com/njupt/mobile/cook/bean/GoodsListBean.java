...
public class GoodsListBean {
    ...
    public static class GoodsCategoryBean {
        ...
        public static class GoodsItemBean {
            ...
            public GoodsItemBean(int goodId, String name, double price, String introduce, Integer goodsImgUrl,double goodPackageMoney) {
                this.goodId = goodId;
                this.name = name;
                this.price = price;
            ...
            public Integer getGoodsImgUrl() {
                return goodsImgUrl;
            }

            public void setGoodsImgUrl(Integer goodsImgUrl) {
                this.goodsImgUrl = goodsImgUrl;
            }
